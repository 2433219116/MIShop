package com.efanzyhang.mi.core.util.storage;
...
/**
 * 项目名：MIShop
 * 包名：com.efanzyhang.mi.core.util.storage
 * 文件名：SPutil
 * 创建者：efan.zyhang
 * 创建时间：2018/9/11 15:05
 * 描述： TODO
 */
public final class SPutil {
        ...
        private static final SharedPreferences PREFERENCES =
                PreferenceManager.getDefaultSharedPreferences(MIShop.getApplicationContext());
